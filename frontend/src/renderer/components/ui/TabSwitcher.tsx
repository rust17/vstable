            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col flex-1 min-w-0">
                  ...
                  {tab.type === 'table' && (
                    <span
                      className={`text-[10px] ${isActive ? 'text-primary-100' : 'text-gray-400'}`}
                    >
                      {tab.schema}.{tab.name}
                    </span>
                  )}
                ...
                {index === 0 && (
                  <span
                    className={`text-[10px] px-1.5 py-0.5 rounded border ${isActive ? 'bg-primary-500/50 border-primary-400 text-white' : 'bg-gray-100 border-gray-200 text-gray-400'}`}
                  >
                    Active
                  </span>
                )}
