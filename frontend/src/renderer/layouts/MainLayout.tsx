    ...
    >
      {!isConnected ? (
        ...
        <div
          ...
          className="flex h-full w-full overflow-hidden bg-white text-gray-900"
        >
          {/* Sidebar */}
          <div
            className={`${isMaximized ? 'hidden' : ''} bg-gray-50 border-r border-gray-200 flex flex-col relative`}
            style={{ width: isMaximized ? 0 : sidebarWidth }}
          >
              ...
              <DatabaseTree
                ...
                activeTable={
                  activeTab?.type === 'table'
                    ? { schema: activeTab.schema!, name: activeTab.name }
                    : null
                }
