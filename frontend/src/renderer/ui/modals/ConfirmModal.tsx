...
export const ConfirmModal: React.FC<ConfirmModalProps> = ({ 
  ...
  const isDeleteAction = confirmText?.toLowerCase().includes('delete') || confirmText?.toLowerCase().includes('drop');
  ...
  return (
    ...
    >
      ...
      >
        <div className={`w-16 h-16 ${isDeleteAction ? 'bg-red-50' : 'bg-primary-50'} rounded-full flex items-center justify-center mb-6`}>
